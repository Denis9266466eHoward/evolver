...
> **個人メモ**: GEP の Gene と Skill の違いについては論文を読むと理解しやすい。特に CritPt の実験結果が面白い。Gene 表現の方がスキルドキュメントより安定しているという結論は直感に反するけど、実験データを見ると納得できる。まず Section 4.2 から読み始めるのがおすすめ。
